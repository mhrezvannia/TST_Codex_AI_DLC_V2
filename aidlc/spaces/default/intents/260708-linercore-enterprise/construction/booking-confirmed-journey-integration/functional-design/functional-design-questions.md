# Functional Design Questions - booking-confirmed-journey-integration
...
A. Own booking.confirmed producer/consumer contract, outbox publication, CMM journey creation/reconciliation, schema compatibility, and message-pact evidence. Recommended from unit-of-work.md and components.md.
...
A. It must not derive movement status or calculate pricing/D&D. Recommended to preserve service ownership boundaries from requirements.md and services.md.
