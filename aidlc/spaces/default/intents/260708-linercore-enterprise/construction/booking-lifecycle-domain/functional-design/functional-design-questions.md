# Functional Design Questions - booking-lifecycle-domain
...
A. Own booking drafts, validation, pricing orchestration state, confirmation, amendments, reconfirmation, revisioning, lifecycle status, exception queues, D&D trigger evaluation, and booking audit. Recommended from unit-of-work.md and components.md.
...
A. It must not calculate prices, D&D rates/free time, or movement status. Recommended to preserve service ownership boundaries from requirements.md and services.md.
