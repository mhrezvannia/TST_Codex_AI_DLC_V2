# Business Rules - Charge Agreement Pricing Domain
...
The accepted recommended answers keep charge-agreement-pricing-domain within its approved boundary and require real evidence before completion.

## Ownership Rules

- charge-agreement-pricing-domain owns agreements, tariffs, charge terms, active lookup, tariff fallback, itemised pricing, manual pricing, D&D rules, free time, rates, chargeable days, and commercial audit.
- charge-agreement-pricing-domain must not mutate Booking lifecycle, derive CMM status, or query Booking/CMM databases.
