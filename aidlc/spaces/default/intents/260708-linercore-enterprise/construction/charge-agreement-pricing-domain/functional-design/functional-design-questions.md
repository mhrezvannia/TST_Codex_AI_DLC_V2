# Functional Design Questions - charge-agreement-pricing-domain
...
A. Own agreements, tariffs, charge terms, active lookup, tariff fallback, itemised pricing, manual pricing, D&D rules, free time, rates, chargeable days, and commercial audit. Recommended from unit-of-work.md and components.md.
...
A. It must not mutate Booking lifecycle, derive CMM status, or query Booking/CMM databases. Recommended to preserve service ownership boundaries from requirements.md and services.md.
