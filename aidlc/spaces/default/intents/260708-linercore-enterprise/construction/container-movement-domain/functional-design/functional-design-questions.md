# Functional Design Questions - container-movement-domain
...
A. Own journeys, expected movements, movement capture, DCSA-aligned validation, ordering/deduplication, status derivation, and movement history. Recommended from unit-of-work.md and components.md.
...
A. It must not decide D&D relevance, mutate Booking lifecycle, or calculate pricing/D&D. Recommended to preserve service ownership boundaries from requirements.md and services.md.
