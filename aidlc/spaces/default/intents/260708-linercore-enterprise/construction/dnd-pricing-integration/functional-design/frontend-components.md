# Frontend Components - D&D Pricing Integration
...
Frontend scope for dnd-pricing-integration: D&D trigger, result, free-time/chargeable-day evidence, manual fallback, and exception views.

## Component Scope

The frontend surface must use real APIs/events/contracts and respect backend ownership. It must not let Booking calculate D&D or let CMM decide D&D relevance.

## Component Hierarchy

`	ext
dnd-pricing-integrationRouteOrPanel
  |
  +-- SummaryPanel
  +-- WorkTableOrTimeline
  +-- DetailDrawer
...
Text fallback: the UI route or panel shows summary status, tabular/timeline work, details, evidence, and exceptions for dnd-pricing-integration.
...
|---|---|
| unit-of-work.md | Defines whether dnd-pricing-integration includes direct UI responsibility or support evidence. |
