# Functional Design Questions - dnd-pricing-integration
...
A. Own Booking D&D boundary trigger, pricing.dnd-request/result seam, Charge D&D calculation handoff, manual fallback, and audit evidence. Recommended from unit-of-work.md and components.md.
...
A. It must not let Booking calculate D&D or let CMM decide D&D relevance. Recommended to preserve service ownership boundaries from requirements.md and services.md.
