# Functional Design Questions - enterprise-seed-migrations-devex
...
A. Own logical database/user setup, migration orchestration, deterministic seed data, reset flows, and developer command documentation. Recommended from unit-of-work.md and components.md.
...
A. It must not replace real business implementation with seed fixtures or allow cross-service SQL joins. Recommended to preserve service ownership boundaries from requirements.md and services.md.
