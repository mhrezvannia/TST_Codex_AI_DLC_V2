# Functional Design Questions - enterprise-web-shell-and-workflows
...
A. Own authenticated shell, navigation, permissions, work queue, module routes, exceptions, audit views, and real API/event-backed workflows. Recommended from unit-of-work.md and components.md.
...
A. It must not own business rules or copy fake Claude prototype logic. Recommended to preserve service ownership boundaries from requirements.md and services.md.
