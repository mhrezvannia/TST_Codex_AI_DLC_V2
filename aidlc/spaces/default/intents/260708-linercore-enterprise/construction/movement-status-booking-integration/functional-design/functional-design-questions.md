# Functional Design Questions - movement-status-booking-integration
...
A. Own containermovement.status producer/consumer contract, CMM publication, Booking consumer lifecycle update, ordering/staleness handling, schema compatibility, and message-pact evidence. Recommended from unit-of-work.md and components.md.
...
A. It must not make Booking derive movement status or make CMM decide D&D relevance. Recommended to preserve service ownership boundaries from requirements.md and services.md.
