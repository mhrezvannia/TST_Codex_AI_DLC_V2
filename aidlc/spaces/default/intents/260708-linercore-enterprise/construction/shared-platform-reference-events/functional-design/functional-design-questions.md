# Functional Design Questions - shared-platform-reference-events
...
A. Own reference set/record lifecycle, reference validation APIs, reference-data changed events, transactional outbox, Schema Registry and Kafka publisher reliability. Recommended from unit-of-work.md and components.md.
...
A. It must not own pricing, booking, CMM, D&D, or cross-service database joins. Recommended to preserve service ownership boundaries from requirements.md and services.md.
