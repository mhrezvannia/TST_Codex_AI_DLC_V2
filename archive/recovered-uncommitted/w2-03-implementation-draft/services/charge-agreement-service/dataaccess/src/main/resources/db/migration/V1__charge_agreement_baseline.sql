CREATE TABLE IF NOT EXISTS charge_agreements (
...
CREATE TABLE IF NOT EXISTS charge_agreement_terms (
...
CREATE TABLE IF NOT EXISTS charge_agreement_activity (
...
CREATE INDEX IF NOT EXISTS idx_charge_agreements_customer_status_validity
    ON charge_agreements(customer_id, status, valid_from, valid_to);
CREATE INDEX IF NOT EXISTS idx_charge_agreements_lane_customer_validity
...
CREATE INDEX IF NOT EXISTS idx_manual_pricing_cases_request ON manual_pricing_cases(pricing_request_id);
...
CREATE INDEX IF NOT EXISTS idx_pricing_requests_status_lease ON pricing_requests(status, lease_until);
